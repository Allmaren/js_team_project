...
import * as fechQuery from './js/fech-query';
import * as fechTrends from './js/fech-trend';
import * as loader from './js/loader';
import * as modalFilm from './js/modal-film';
import * as registration from './js/modal-registared';
...
import * as fechFilm from './js/fech-film/fech-film';
